            ...
            return DynamicIsland {
                ...
                DynamicIslandExpandedRegion(.bottom) {
                    VStack(alignment: .leading, spacing: 9) {
                        ...
                        GlowProgressBar(progress: focusProgress(for: context.state), accent: accent, height: 7)
                    }
                    .padding(.top, 2)
                }
            } compactLeading: {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 13) {
            ...
            VStack(alignment: .leading, spacing: 9) {
                ...
                GlowProgressBar(progress: focusProgress(for: context.state), accent: accent, height: 8)
            }
        }
        .padding(16)
        .background(
            ZStack {
                ...
                RadialGradient(colors: [accent.opacity(0.16), .clear], center: .topTrailing, startRadius: 6, endRadius: 200)
...
private func focusAccent(for state: FocusAttributes.ContentState) -> Color {
    ...
    case "workout": return UpdoWidgetPalette.green
    case "crew":    return UpdoWidgetPalette.purple
    default:        return UpdoWidgetPalette.cyan
    }
}
...
private func focusStatusText(for state: FocusAttributes.ContentState) -> String {
    ...
    switch state.modeRaw {
    case "workout": return "Workout sürüyor"
    case "crew":    return "Ortak focus sürüyor"
    default:        return "Focus sürüyor"
    }
}

    ...
    static func forMode(_ mode: FocusMode) -> FocusStageTheme {
        ...
        case .personal:
            return FocusStageTheme(
                baseTop: Color(red: 0.10, green: 0.14, blue: 0.36),
                baseMid: Color(red: 0.05, green: 0.09, blue: 0.24),
                baseBottom: Color(red: 0.01, green: 0.03, blue: 0.10),
                primaryBloom: Color(red: 0.42, green: 0.64, blue: 1.00),
                secondaryBloom: Color(red: 0.60, green: 0.46, blue: 1.00),
                coreBloom: Color(red: 0.30, green: 0.50, blue: 1.00),
                innerGlow: Color(red: 0.22, green: 0.38, blue: 0.96),
                ringTint: Color(red: 0.92, green: 0.96, blue: 1.00),
                dotColor: Color(red: 0.78, green: 0.90, blue: 1.00)
            )

        case .crew:
            return FocusStageTheme(
                baseTop: Color(red: 0.32, green: 0.09, blue: 0.13),
                baseMid: Color(red: 0.20, green: 0.04, blue: 0.08),
                baseBottom: Color(red: 0.08, green: 0.01, blue: 0.03),
                primaryBloom: Color(red: 1.00, green: 0.42, blue: 0.50),
                secondaryBloom: Color(red: 1.00, green: 0.62, blue: 0.48),
                coreBloom: Color(red: 0.90, green: 0.18, blue: 0.30),
                innerGlow: Color(red: 0.62, green: 0.10, blue: 0.16),
                ringTint: Color(red: 1.00, green: 0.91, blue: 0.93),
                dotColor: Color(red: 1.00, green: 0.82, blue: 0.84)
            )

        case .friend:
            return FocusStageTheme(
                baseTop: Color(red: 0.22, green: 0.09, blue: 0.31),
                baseMid: Color(red: 0.13, green: 0.05, blue: 0.20),
                baseBottom: Color(red: 0.05, green: 0.02, blue: 0.10),
                primaryBloom: Color(red: 0.88, green: 0.52, blue: 1.00),
                secondaryBloom: Color(red: 0.62, green: 0.54, blue: 1.00),
                coreBloom: Color(red: 0.64, green: 0.26, blue: 0.94),
                innerGlow: Color(red: 0.40, green: 0.16, blue: 0.70),
                ringTint: Color(red: 0.97, green: 0.90, blue: 1.00),
                dotColor: Color(red: 0.93, green: 0.85, blue: 1.00)
            )
        }
    }
}
